...
// Get today's registrations for the table
$todayRegStmt = $conn->prepare("SELECT * FROM registrations WHERE DATE(created_at) = ? ORDER BY created_at DESC");
$todayRegStmt->bind_param("s", $today);
$todayRegStmt->execute();
$todayRegistrations = $todayRegStmt->get_result();
    ...
    <div class="table-card">
        <div class="table-header">
            ...
            <div>
                ...
                <span class="count-badge"><?php echo $totalToday; ?> คน</span>
            </div>
        </div>
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                    <?php
                    $num = 1;
                    while ($row = $todayRegistrations->fetch_assoc()):
                    ?>
                    <tr>
                        <td><?php echo $num++; ?></td>
                        <td>
